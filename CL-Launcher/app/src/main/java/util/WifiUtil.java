...
/**
 * Created by IMFCORP\alok.acharya on 20/3/17.
 */
...
public class WifiUtil {
    ...
    public static boolean connectToWifiNetwork(Context context, String networkSSID, String networkPass, String security) {
        LogUtil.createLog(TAG, "Connecting to SSID \"" + networkSSID + "\" with password \"" + networkPass + "\" and with security \"" + security + "\" ...");
        ...
        LogUtil.createLog(TAG, "Network ID: " + networkId);
